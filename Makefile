...
bin/Getsize.o : src/Getsize.cpp src/Getsize.h
	g++ $(FLAGS) -c $< -o $@


main : bin/main.o bin/Display_function.o bin/Refresh_scoreboard.o bin/Wall_create_function.o bin/Count_marks.o bin/Skill.o bin/Start_and_end_function.o bin/Ranklist_process_function.o bin/Getsize.o
	g++ $(FLAGS) $^ -o main
